export const translations = {
  en: {
    ...
    rotationQuotaBatchDesc: "Prefer weekly quota, then primary; switch after approximately this additional usage.",
    rotationQuotaBatchPercent: "Additional usage before switching",
    rotationSaved: "Saved",
  ...
  zh: {
    ...
    rotationQuotaBatchDesc: "优先使用周额度，无周额度时使用主额度；大约增加指定用量后切换账号。",
    rotationQuotaBatchPercent: "切换前新增用量",
    rotationSaved: "\u5df2\u4fdd\u5b58",
