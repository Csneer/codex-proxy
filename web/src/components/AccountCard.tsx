...
export function AccountCard({ account, index, onDelete, proxies, onProxyChange, selected, onToggleSelect, onRefreshQuota, onToggleStatus, onUpdateLabel }: AccountCardProps) {
  ...
  return (
    <div class={`account-card rounded-xl p-4 transition-all ${selected ? "border-primary ring-1 ring-primary/30" : "hover:border-primary/40 dark:hover:border-primary/50"}`}>
      {/* Header */}
