...
describe("AccountPool quota methods", () => {
  ...
  describe("updateCachedQuota", () => {
    ...
    it("preserves existing reset_credits_available when new quota lacks them", () => {
    ...
    it("overwrites reset_credits_available when new quota explicitly provides a number", () => {
